...
class ConveyorSimulator(Dataset):
    def __init__(self, data_path, transform=None, num_classes=4):
        ...
        self._json_path = data_path + '/metaData.json'
    ...
    def __getitem__(self, index):
        ...
        image = Image.open(self._data_path + '/images/' + img_id)
        ...
        masks = Image.open(self._data_path + '/masks/' + img_id)
...
if __name__ == '__main__':
    ...
    training_path = dir_path + '/data/training/'
